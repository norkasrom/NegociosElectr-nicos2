...
namespace someexam.Droid
{
    public class LVAdapter : BaseAdapter<Estudiante>
    {
        ...
        public override View GetView(int position, View convertView, ViewGroup parent)
        {
            ...
            view.FindViewById<TextView>(Resource.Id.txtNumCtrl).Text = item.NumeroControl;
            view.FindViewById<TextView>(Resource.Id.txtCalif).Text = item.Calificacion.ToString();
            //view.FindViewById();
            return view;
        }
    }
