...
extern void *mono_aot_module_ProyectoCRM_iOS_info;
extern void *mono_aot_module_mscorlib_info;
extern void *mono_aot_module_Xamarin_iOS_info;
extern void *mono_aot_module_System_info;
extern void *mono_aot_module_System_Core_info;
extern void *mono_aot_module_ProyectoCRM_info;
...
{
	mono_aot_register_module (mono_aot_module_ProyectoCRM_iOS_info);
	mono_aot_register_module (mono_aot_module_mscorlib_info);
	mono_aot_register_module (mono_aot_module_Xamarin_iOS_info);
	mono_aot_register_module (mono_aot_module_System_info);
	mono_aot_register_module (mono_aot_module_System_Core_info);
	mono_aot_register_module (mono_aot_module_ProyectoCRM_info);
...
void xamarin_setup_impl ()
{
	...
	xamarin_executable_name = "ProyectoCRM.iOS.exe";
	mono_use_llvm = FALSE;
	xamarin_log_level = 0;
